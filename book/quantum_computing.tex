...
% chapter format
\titleformat{\chapter}%
  {\huge\rmfamily\itshape}% format applied to label+text. If needed, we can add \color{red}
...
\titleformat{\subsubsection}%
  [hang]
  {\normalfont\Large\itshape}% format applied to label+text
  {\llap{\colorbox{purple}{\parbox{1.5cm}{\hfill\color{white}\thesubsubsection}}}}% label
  {1em}% horizontal separation between label and title body
  {}% before the title body
  []% after the title body
